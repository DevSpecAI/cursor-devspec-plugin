...
13. **Create an isolated worktree (not a branch-in-place).**
    ...
    c. **Compute `worktree_path`** as a hidden sibling directory of the main repo (the same convention ``autopilot.process`` uses):
    ```
